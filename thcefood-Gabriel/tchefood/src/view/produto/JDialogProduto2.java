...
public class JDialogProduto2 extends javax.swing.JDialog 
{
    private int id;
    ...
    public JDialogProduto2(java.awt.Frame parent, boolean modal, int id) 
    {
        super(parent, modal);
        this.id = id;
        //this.pedido = pedido;
    ...
    {
        int idProduto = JDialogPedidoCardapio2.itens.get(id).getId();
        produto = ProdutoDAO2.obterProdutoPorID(idProduto);
        
        System.out.println("IDDDDDDDDDD: " + id);
        System.out.println("IDDDDDDDDDD: " + idProduto);
        System.out.println("produto id " + produto.getId());
        System.out.println("produto nome " + produto.getNome());
        System.out.println("produto descricao " + produto.getDescricao());
        System.out.println("produto preco " + produto.getPreco());
        ...
        try 
        {
            //String caminhoImagem = "/images/" + JDialogPedidoCardapio2.produtos.get(id).getImagem();
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        itemPedido.setPedidoId(JDialogPedidoCardapio2.modelPedido);
        ...
        TableModelItensPedido tableModel = new TableModelItensPedido(ItensPedidoDAO.carregarItensDoPedido(JDialogPedidoCardapio2.modelPedido.getId()));
        JDialogPedidoCardapio2.jTableItensPedido.setModel(tableModel);
    ...
    private void atualizarTotal()
    {
        ...
        JDialogPedidoCardapio2.modelPedido.setTotal(JDialogPedidoCardapio2.modelPedido.getTotal() + total);
    ...
    public static void main(String args[]) 
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogProduto2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
